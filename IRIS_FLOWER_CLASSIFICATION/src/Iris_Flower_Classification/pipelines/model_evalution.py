import pickle
from src.Iris_Flower_Classification.components.model_train import ModelTraining
from src.Iris_Flower_Classification.logger import logging
from src.Iris_Flower_Classification.components.data_ingestion import Training_x_y
import pandas as pd
...
class Model_Evaluation:
    ...
    def evaluate_models(self):
        ...
        transformed_data = model_trainer.data_preprocessing(data)

        # Split the data into training and testing sets
        obj2 = Training_x_y(transformed_data)
...
if __name__ == "__main__":
    data_file_path = r'D:\OI\Task_1\notebooks\data\Iris.csv'
    model_evaluation = Model_Evaluation(data_file_path)
